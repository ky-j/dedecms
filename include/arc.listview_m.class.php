 ...
 * 文档列表类
 *
* @version        $Id: arc.listview_m.class.php 2017-04-14 julisky $
 */
...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"am-pagination-prev\"><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></li>\r\n";
            $indexpage="<li class='am-pagination-first'><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
            $prepage.="<li class=\"am-pagination-prev\"><a href=\"#\">上一页</a></li>\r\n";
            $indexpage="";
        }
        ...
        {
            $nextpage.="<li class=\"am-pagination-next\"><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></li>\r\n";
            $endpage="<li class=\"am-pagination-last\"><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
            $nextpage.="<li class=\"am-pagination-next\"><a href=\"#\">下一页</a></li>\r\n";
            $endpage="";
        }
        ...
        $optionlist = "<li class=\"am-pagination-select\"><select name='sldd' onchange='location.href=this.options[this.selectedIndex].value;'>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"am-active\"><a href=\"#\" class=\"am-active\">$j</a></li>\r\n";
            }
            else
            {
