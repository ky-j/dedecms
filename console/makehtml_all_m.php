 ...
 * 移动端生成所有页面
 *
 * @version        $Id: makehtml_all_m.php 2017-04-14 julisky $
 */
...
else if($action=='make')
{
    ...
    if($step==3)
    {
        ...
        $templet = str_replace('.htm','_m.htm',$templet); //模板替换为index_m.htm
        $row['position'] = str_replace("../", '../m/',$row['position']); //生成文件位置为/m/
