 ...
 * 移动端生成文档操作
 *
 * @version        $Id: makehtml_archives_action_m.php 2017-04-14 julisky $
 */
define('DEDEMOB', 'Y'); // 定义移动版标识，用于arc.archives_m.class.php中的GetTempletFile方法
require_once(dirname(__FILE__)."/config.php");
CheckPurview('sys_MakeHtml_m'); // 检查权限
